...
if __name__ == '__main__':
    ...
    content_image, content_shape = vgg.load_image('../hang.jpg', IMAGE_HEIGHT, IMAGE_WIDTH)
    style_image, _ = vgg.load_image('../1_style.jpg', IMAGE_HEIGHT, IMAGE_WIDTH)
    ...
    for step in range(TRAIN_STEP):
        ...
        if step % 1 == 0:
            ...
            vgg.save_image(transfer_image, content_shape, '7_output/output_' + str(step) + '.jpg')
            start = time.time()
