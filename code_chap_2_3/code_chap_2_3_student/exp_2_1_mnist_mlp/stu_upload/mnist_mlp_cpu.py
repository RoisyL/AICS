...
class MNIST_MLP(object):
    def __init__(self, batch_size=100, input_size=784, hidden1=512, hidden2=256, out_classes=10, lr=0.01, max_epoch=1, print_iter=100):
...
def build_mnist_mlp(param_dir='weight.npy'):
    h1, h2, e, batch_size = 512, 256, 10, 100
    mlp = MNIST_MLP(hidden1=h1, hidden2=h2, max_epoch=e)
    mlp.load_data()
    mlp.build_model()
    mlp.init_model()
    mlp.train()
    mlp.save_model('mlp-%d-%d-%d-%d.npy' % (h1, h2, e, batch_size))
