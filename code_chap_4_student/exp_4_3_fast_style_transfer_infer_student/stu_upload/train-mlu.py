...
if __name__ == '__main__':
    ...
    image_style_mlu = image_style.to(torch_mlu.core.mlu_model.mlu_device())
    net = VGG19().cpu()
    g_net = TransNet().cpu()
    #TODO: 将特征网络加载到mlu得到mlu_g_net
    mlu_g_net = g_net.to(torch_mlu.core.mlu_model.mlu_device())
    #TODO: 将图像转换网络加载到mlu得到mlu_net
    mlu_net = net.to(torch_mlu.core.mlu_model.mlu_device())
    ...
    mlu_loss_func = loss_func.to(torch_mlu.core.mlu_model.mlu_device())
    ...
    while j <= epochs:
        for i, image in enumerate(data_loader):
            ...
            mlu_image_c = image_c.to(torch_mlu.core.mlu_model.mlu_device())
            ...
            if i % 10 == 0:
                ...
                save_image(torch.cat((mlu_image_c, mlu_image_g), -1), f'out/train_mlu/output_{j}_{i}.jpg')
        j += 1
